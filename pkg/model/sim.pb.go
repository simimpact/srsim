...
var file_pb_model_sim_proto_rawDesc = []byte{
	...
	0x04, 0x08, 0x04, 0x10, 0x05, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22, 0x54, 0x0a, 0x11, 0x53,
	...
	0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x69, 0x74, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x22, 0x2e, 0x0a, 0x04, 0x57, 0x61, 0x76, 0x65, 0x12, 0x26, 0x0a, 0x07, 0x65, 0x6e, 0x65,
...
var file_pb_model_sim_proto_goTypes = []any{
...
func file_pb_model_sim_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pb_model_sim_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pb_model_sim_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pb_model_sim_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Wave); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pb_model_sim_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Engage); i {
			case 0:
				return &v.state
			case 1:
	...
	file_pb_model_sim_proto_msgTypes[0].OneofWrappers = []any{
		(*SimConfig_Gcsl)(nil),
	}
	type x struct{}
