...
const (
	SkillEffect_INVALID_SKILL_EFFECT SkillEffect = 0
	SkillEffect_SINGLE               SkillEffect = 1
	SkillEffect_AOE                  SkillEffect = 2
	SkillEffect_SHIELD_BREAK         SkillEffect = 3
	SkillEffect_BOUNCE               SkillEffect = 4
	SkillEffect_BLAST                SkillEffect = 5
	SkillEffect_SUPPORT              SkillEffect = 6
	SkillEffect_WEAKEN               SkillEffect = 7
	SkillEffect_IMPAIR               SkillEffect = 8
	SkillEffect_RESTORE              SkillEffect = 9
	SkillEffect_TAUNT                SkillEffect = 10
	SkillEffect_DEFENSE              SkillEffect = 11
	SkillEffect_DAMAGE               SkillEffect = 12
	SkillEffect_ENHANCE              SkillEffect = 13
	SkillEffect_TRANSFORM            SkillEffect = 14
	SkillEffect_PASSIVE              SkillEffect = 15
	SkillEffect_MAZE_ATTACK          SkillEffect = 16
)

// Enum value maps for SkillEffect.
var (
	SkillEffect_name = map[int32]string{
		0:  "INVALID_SKILL_EFFECT",
		1:  "SINGLE",
		2:  "AOE",
		3:  "SHIELD_BREAK",
		4:  "BOUNCE",
	...
	SkillEffect_value = map[string]int32{
		"INVALID_SKILL_EFFECT": 0,
		"SINGLE":               1,
		"AOE":                  2,
		"SHIELD_BREAK":         3,
		"BOUNCE":               4,
...
func (x SkillEffect) Enum() *SkillEffect {
	p := new(SkillEffect)
	*p = x
	return p
}
...
func (SkillEffect) Descriptor() protoreflect.EnumDescriptor {
	return file_pb_model_enum_proto_enumTypes[6].Descriptor()
}

func (SkillEffect) Type() protoreflect.EnumType {
	return &file_pb_model_enum_proto_enumTypes[6]
}

func (x SkillEffect) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SkillEffect.Descriptor instead.
func (SkillEffect) EnumDescriptor() ([]byte, []int) {
...
var file_pb_model_enum_proto_rawDesc = []byte{
	...
	0x41, 0x4d, 0x41, 0x47, 0x45, 0x10, 0x09, 0x2a, 0xf5, 0x01, 0x0a, 0x0b, 0x53, 0x6b, 0x69, 0x6c,
	0x6c, 0x45, 0x66, 0x66, 0x65, 0x63, 0x74, 0x12, 0x18, 0x0a, 0x14, 0x49, 0x4e, 0x56, 0x41, 0x4c,
	0x49, 0x44, 0x5f, 0x53, 0x4b, 0x49, 0x4c, 0x4c, 0x5f, 0x45, 0x46, 0x46, 0x45, 0x43, 0x54, 0x10,
	...
	0x48, 0x50, 0x10, 0x02, 0x2a, 0x48, 0x0a, 0x0a, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x17, 0x0a, 0x13, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x5f, 0x54, 0x41,
	0x52, 0x47, 0x45, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x53,
	0x45, 0x4c, 0x46, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x41, 0x4c, 0x4c, 0x49, 0x45, 0x53, 0x10,
	0x02, 0x12, 0x0b, 0x0a, 0x07, 0x45, 0x4e, 0x45, 0x4d, 0x49, 0x45, 0x53, 0x10, 0x03, 0x42, 0x26,
...
var file_pb_model_enum_proto_enumTypes = make([]protoimpl.EnumInfo, 11)
