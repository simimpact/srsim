...
export interface OuterLablePieProps<Datum> {
  width: number;
  height: number;
...
export const OuterLabelPie = <Datum,>({
  width,
  height,
  data,
  color,
    ...
    <div className="relative">
      <svg width={width} height={height}>
        <Group left={width / 2} top={height / 2}>
          ...
          {/* tooltip hover arcs */}
          <Pie data={data} pieValue={pieValue} outerRadius={radius * pieRadius + (tail * 2) / 3}>
            {pie => {
