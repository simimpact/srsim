...
const TabsList = React.forwardRef<React.ElementRef<typeof TabsPrimitive.List>, ListProps>(
  ({ className, ...props }, ref) => (
    <TabsPrimitive.List
      ref={ref}
      className={cn(
...
const TabsContent = React.forwardRef<React.ElementRef<typeof TabsPrimitive.Content>, ContentProps>(
  ({ className, ...props }, ref) => (
