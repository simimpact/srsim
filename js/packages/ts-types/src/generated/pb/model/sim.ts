...
export const SimConfig = {
  encode(message: SimConfig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.settings !== undefined) {
      SimulatorSettings.encode(message.settings, writer.uint32(10).fork()).ldelim();
    }
    ...
    if (message.enemies !== undefined && message.enemies.length !== 0) {
      for (const v of message.enemies) {
        Enemy.encode(v!, writer.uint32(26).fork()).ldelim();
      }
    }
    if (message.engage !== undefined) {
      Engage.encode(message.engage, writer.uint32(50).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SimConfig {
...
export const Wave = {
  encode(message: Wave, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.enemies !== undefined && message.enemies.length !== 0) {
      for (const v of message.enemies) {
        Enemy.encode(v!, writer.uint32(10).fork()).ldelim();
      }
    }
    return writer;
  },
...
export const Engage = {
  encode(message: Engage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Engage {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
