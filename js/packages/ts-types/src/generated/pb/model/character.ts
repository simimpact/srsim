...
export const Character: MessageFns<Character> = {
  encode(message: Character, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.abilities !== undefined) {
      Abilities.encode(message.abilities, writer.uint32(50).fork()).join();
    }
    if (message.lightCone !== undefined) {
      LightCone.encode(message.lightCone, writer.uint32(58).fork()).join();
    }
    if (message.relics !== undefined && message.relics.length !== 0) {
      for (const v of message.relics) {
        Relic.encode(v!, writer.uint32(66).fork()).join();
      }
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          const el = Relic.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.relics!.push(el);
          }
          continue;
        }
        case 9: {
...
export const Abilities: MessageFns<Abilities> = {
  encode(message: Abilities, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Abilities {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LightCone: MessageFns<LightCone> = {
  encode(message: LightCone, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== undefined && message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.level !== undefined && message.level !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LightCone {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Relic: MessageFns<Relic> = {
  encode(message: Relic, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== undefined && message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.mainStat !== undefined) {
      RelicStat.encode(message.mainStat, writer.uint32(18).fork()).join();
    }
    if (message.subStats !== undefined && message.subStats.length !== 0) {
      for (const v of message.subStats) {
        RelicStat.encode(v!, writer.uint32(26).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Relic {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          const el = RelicStat.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.subStats!.push(el);
          }
          continue;
        }
      }
...
export const RelicStat: MessageFns<RelicStat> = {
  encode(message: RelicStat, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RelicStat {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
