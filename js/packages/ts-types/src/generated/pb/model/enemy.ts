  ...
  encode(message: Enemy, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.debuffRes !== undefined && message.debuffRes.length !== 0) {
      for (const v of message.debuffRes) {
        DebuffRES.encode(v!, writer.uint32(34).fork()).ldelim();
      }
    }
    if (message.damageRes !== undefined && message.damageRes.length !== 0) {
      for (const v of message.damageRes) {
        DamageRES.encode(v!, writer.uint32(42).fork()).ldelim();
      }
    }
    ...
    if (message.baseStats !== undefined) {
      BaseStats.encode(message.baseStats, writer.uint32(58).fork()).ldelim();
    }
    if (message.parameters !== undefined) {
      Struct.encode(Struct.wrap(message.parameters), writer.uint32(82).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.debuffRes!.push(DebuffRES.decode(reader, reader.uint32()));
          continue;
        case 5:
          if (tag !== 42) {
            break;
          ...
          message.damageRes!.push(DamageRES.decode(reader, reader.uint32()));
          continue;
        case 6:
          if (tag !== 48) {
            break;
...
export const DebuffRES = {
  encode(message: DebuffRES, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DebuffRES {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DamageRES = {
  encode(message: DamageRES, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DamageRES {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BaseStats = {
  encode(message: BaseStats, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BaseStats {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
