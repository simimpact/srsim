...
//go:generate mockgen -destination=mock_attribute.go -package=mock -mock_names Modifier=MockAttribute github.com/simimpact/srsim/pkg/engine/attribute Modifier
